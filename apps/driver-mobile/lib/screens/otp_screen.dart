            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  counterText: '',
                  hintText: '------',
                  hintStyle: TextStyle(fontSize: 28, letterSpacing: 16, color: Colors.grey[300]),
                  filled: true,
                ...
                onChanged: (value) {
                  if (value.length == 6) _verifyOtp(phone);
                },
              ),
              ...
              Center(
                child: Container(
                  ...
                  child: const Text(
                    ...
                    style: TextStyle(fontSize: 13, color: FairGoTheme.primaryDark, fontWeight: FontWeight.w500),
                  ),
                ),
              ),
            ],
